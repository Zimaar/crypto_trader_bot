...
POLL_INTERVAL_BREAKOUTS_SECONDS = int(os.getenv("POLL_INTERVAL_BREAKOUTS_SECONDS", "300"))
POLL_INTERVAL_MOMENTUM_SECONDS = int(os.getenv("POLL_INTERVAL_MOMENTUM_SECONDS", "600"))
PULLBACK_POLLING_ENABLED = os.getenv("PULLBACK_POLLING_ENABLED", "false").lower() == "true"
