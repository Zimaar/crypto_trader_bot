...
POLL_INTERVAL_SCREENER = int(os.getenv("POLL_INTERVAL_SCREENER", "900"))
POLL_INTERVAL_NEWS = int(os.getenv("POLL_INTERVAL_NEWS", "600"))
POLL_INTERVAL_TA = 3600
POLL_INTERVAL_EVENTS = 21600
POLL_INTERVAL_GEO = 900
POLL_INTERVAL_TRAILING = 300
